...
Module SWPPARAMS
	...
	Integer, Parameter :: MIN_PARTICLE_SIZE = 1
	...
	Real, Parameter		::	RHOS	= 1.8E0 ! g/cm3

	! Avogadro's number.
	Real, Parameter		::	NA		= 6.022E23

	! PI.
	Real, Parameter		::	PI		= 3.1415926535897932384626433832795E0

	! Boltzmann's constant.
	Real, Parameter		::	KB		= 1.3807E-16 ! gcm2/s2K

	! Site density on soot surface.
	Real, Parameter		::	CHI		= 2.3E15 ! 1/cm2

	! Ideal gas constant.
	Real, Parameter		::	R		= 8.3145E0	 ! J/molK
	...
	Real, Parameter		::	ONE_THIRD	= 3.3333334E-01
	Real, Parameter		::	TWO_THIRDS	= 6.6666667E-01
	Real, Parameter		::	ONE_SIXTH	= 1.6666667E-01
	Real, Parameter		::	ONE_HALF	= 5.0000000E-01
    Real, Parameter     ::  ROOT_TWO    = 1.41421356E0
